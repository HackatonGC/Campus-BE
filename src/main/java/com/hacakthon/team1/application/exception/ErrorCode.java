...
public enum ErrorCode {
    ...
    QNA_ANSWER_NOT_FOUND(HttpStatus.NOT_FOUND, "존재하지 않는 답변입니다."),
    QNA_ACCESS_DENIED(HttpStatus.FORBIDDEN, "본인의 질문만 삭제하거나 답변을 채택할 수 있습니다."),
    QNA_ANSWER_ACCESS_DENIED(HttpStatus.FORBIDDEN, "본인의 답변만 삭제할 수 있습니다."),
    QNA_ALREADY_SOLVED(HttpStatus.CONFLICT, "이미 채택된 질문입니다."),
